...
export function LoginPage() {
  ...
  return (
    <main className="relative grid min-h-[100dvh] place-items-center overflow-x-hidden bg-[#eef5f6] px-2 py-3 sm:px-4 sm:py-5 lg:h-[100dvh] lg:min-h-0 lg:overflow-hidden lg:p-6">
      ...
      <section className="relative grid min-w-0 w-full max-w-[min(27rem,calc(100vw-1rem))] overflow-hidden rounded-[18px] border border-white/80 bg-white/95 shadow-2xl shadow-slate-900/10 backdrop-blur lg:h-[min(724px,calc(100dvh-3rem))] lg:min-h-0 lg:max-w-[min(97rem,calc(100vw-3rem))] lg:grid-cols-[0.94fr_1.06fr] lg:rounded-[24px]">
        <aside className="relative hidden min-h-0 overflow-hidden bg-[#0b1f33] p-[clamp(2rem,3.3vw,3.2rem)] text-white lg:block">
          ...
          <div className="relative flex h-full flex-col justify-between gap-4">
            ...
            <div>
              ...
              <h2 className="heading max-w-[34rem] text-[clamp(2.15rem,4vw,3.55rem)] font-extrabold leading-[1.14]">
        ...
        <form onSubmit={submit} className="flex min-h-0 min-w-0 flex-col justify-center p-[clamp(0.8rem,4vw,2rem)] lg:px-[clamp(3rem,5vw,4.2rem)] lg:py-[clamp(2rem,4vw,3rem)]">
          ...
          <div className="mt-[clamp(0.75rem,3.5vw,1.25rem)] space-y-[clamp(0.65rem,2.8vw,0.85rem)] lg:mt-14 lg:space-y-9">
