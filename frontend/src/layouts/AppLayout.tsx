        ...
        <nav className="flex flex-1 flex-col gap-2 overflow-y-auto p-2 lg:px-4 lg:py-5">
          {visibleItems.map((item, index) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `group flex h-auto w-full items-center justify-start gap-2 rounded-[12px] px-3 py-3 text-[12px] font-bold transition duration-200 lg:gap-3 lg:px-4 lg:text-sm ${
                  isActive
              ...
              title={item.label}
            >
              <item.icon size={16} className="shrink-0 transition group-hover:scale-110" />
